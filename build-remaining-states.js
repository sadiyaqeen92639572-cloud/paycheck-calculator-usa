...
const STATES = {
    ...
    ma: { name: 'Massachusetts', formula_model: 'flat_tax', effective_date: '2023-01-01',
        ...
        params: { rate: 0.05, personal_exemption: 4400, surtax: { threshold: 1107750, rate: 0.04 } },
        extra_deviation: 'The millionaire\'s surtax threshold is inflation-indexed annually; $1,107,750 is the most recently published figure at last-verified date — confirm current threshold at mass.gov before relying on this near the boundary.' },
